...
const Footer: React.FC = () => {
  ...
  return (
    <section className="bg-[#011520] flex flex-col justify-center px-4 md:py-6 md:px-10 lg:px-24 xl:max-h-[405px] lg:h-[404px] h-[450px] ">
        ...
        <div className="flex justify-between lg:w-[227px]">
          <div className="flex flex-col gap-2">
            {navLinks.map((a) => (
              ...
              >
                {a.id === 1 && <Link to={a.link}>Home</Link>}
