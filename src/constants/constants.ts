...
import { getBlogs, type BlogTypes } from "../../app/lib/blog";
import {
  Python,
  Node,
  ReactJS,
...
// Blog data is defined once in app/lib/blog.ts (single source of truth used by
// the blog routes, metadata, and sitemap). Re-exported here so the blog list and
// detail body never drift out of sync.
